...
public class MixedTableFileScanHelper implements TableFileScanHelper {
  private static final Logger LOG = LoggerFactory.getLogger(MixedTableFileScanHelper.class);
  ...
  public MixedTableFileScanHelper(
      ArcticTable arcticTable, long changeSnapshotId, long baseSnapshotId) {
  ...
  public CloseableIterable<FileScanResult> scan() {
    ...
    if (arcticTable.isKeyedTable() && changeSnapshotId > 0) {
      ...
      StructLikeMap<Long> optimizedSequence =
          baseSnapshotId <= 0
              ...
              : ArcticTableUtil.readOptimizedSequence(keyedTable, baseSnapshotId);
  ...
  @Override
  public MixedTableFileScanHelper withPartitionFilter(Expression partitionFilter) {
  ...
  private class ChangeFiles {
    ...
    public void addFile(DataFile file) {
      PartitionSpec spec = arcticTable.asKeyedTable().changeTable().specs().get(file.specId());
